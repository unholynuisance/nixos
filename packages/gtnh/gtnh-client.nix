...
, hash, jdk ? jdk21, jdk21, fetchurl, fetchzip, unzip }:
let
  src = fetchzip {
    inherit url hash;
    stripRoot = false;
  ...
  foamfix = fetchurl {
    url =
      "https://mediafilez.forgecdn.net/files/4473/363/FoamFix-1.7.10-universal-1.0.4.jar";
    hash = "sha256-PIKmAUnwJNmgLNWC/9Sa7jbbojlK8wZeBU2Oa1Nk08Y=";
  };

  matmos = fetchurl {
    url =
      "https://mediafilez.forgecdn.net/files/5107/45/matmos-1.7.10-36.0.1.jar";
    hash = "sha256-B5MsNO6Z0sXo6BnxKgXtI/HLSnw9xIeDqiEBy2Cb5J8=";
  };

  dynamic-surroundings = fetchurl {
    url =
      "https://mediafilez.forgecdn.net/files/2642/381/DynamicSurroundings-1.7.10-1.0.6.4.jar";
