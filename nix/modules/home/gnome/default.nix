...
in
{
  ...
  config =
    let
      ...
      extensions = {
        "org/gnome/shell" = {
          ...
          enabled-extensions = lib.lists.forEach cfg.extensions (x: x.passthru.extensionUuid);
        };
      };
          ...
          attrs =
            ...
            mapAttrs' (
              ...
              (
                ...
                nameValuePair (path n) (v // { apps = appsToDesktopFiles v.apps; })
              )
            ) (cfg.appFolders);
    ...
    lib.mkIf cfg.enable (
      lib.mkMerge [
        {
          nuisance.modules.hm.gnome = {
            keyboard-shortcuts.enable = true;
          };
